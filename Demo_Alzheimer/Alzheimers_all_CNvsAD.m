...
for data_num=1:length(dataSet)
    ...
    Range_rr = 1;
    Range_C = power(2,-3:3);
    Range_Cl = power(2,-3:3);
    
    if ~exist(['Results/alzheimer/' dataset_name])
       mkdir (['Results/alzheimer/' dataset_name])
    end

    %%% load dataset files
    load(['../src/data/alzheimer/' dataset_name]);
    ...
    save(['Results/alzheimer/' dataset_name '/' dataset_name '_valNOG'], 'accuMLval','sensMLval','specMLval','precMLval','recMLval','f11MLval','gmMLval');
    save(['Results/alzheimer/' dataset_name '/' dataset_name '_valMSCV'], 'accuDKRLval','sensDKRLval','specDKRLval','precDKRLval','recDKRLval','f11DKRLval','gmDKRLval'); 
    ...
    save(['Results/alzheimer/' dataset_name '/Results.mat'],'dataset_name','f11','gm','accu','prec','rec');
