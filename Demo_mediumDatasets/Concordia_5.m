...
for data_num=1:length(dataSet)
    ...
    if ~exist(['Results/benchmarkMedium/' dataset_name])
       mkdir (['Results/benchmarkMedium/' dataset_name])
    end

    %%% load data
    load(['../src/data/benchmarkMedium/' dataset_name]);
    ...
    save(['Results/benchmarkMedium/' dataset_name '/' dataset_name '_valNOG'], 'accuMLval','sensMLval','specMLval','precMLval','recMLval','f11MLval','gmMLval');
    save(['Results/benchmarkMedium/' dataset_name '/' dataset_name '_valMSCV'], 'accuDKRLval','sensDKRLval','specDKRLval','precDKRLval','recDKRLval','f11DKRLval','gmDKRLval'); 
    ...
    save(['Results/benchmarkMedium/' dataset_name '/Results.mat'],'dataset_name','f11','gm','accu','prec','rec');
